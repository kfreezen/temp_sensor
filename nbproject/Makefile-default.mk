...
SOURCEFILES_QUOTED_IF_SPACED=main.c timer.c uart.c xbee.c adc.c eeprom.c packets.c crc16.c
...
# Source Files
SOURCEFILES=main.c timer.c uart.c xbee.c adc.c eeprom.c packets.c crc16.c
